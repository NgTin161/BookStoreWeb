...
import { Input, Form, Button, message, Space, Modal } from 'antd';
...
const PopupRegister =({setIsModalRegisterOpen, isModalRegisterOpen, setIsModalOpen, isModalOpen}) => {
    ...
    return (
        <>     
            <Modal
        open={isModalRegisterOpen} onCancel={handleCancel} footer={null}
        style ={{ padding: '20px', display:'flex',justifyContent:'center' }}
       >
        <div style ={{ padding: '20px', display:'flex',flexDirection:'column' ,justifyContent:'center',alignItems:'center',borderRadius:'20px' }} >
                  <h1 style={{ padding: '15px', fontSize: '30px' }} className='login-name'>ĐĂNG KÝ</h1>
                    ...
                    <div class="signup" style={{ color: 'black' }}>
                        Đã có tài khoản? <a  onClick={handleOpenLogin}> Đăng nhập </a>
                    </div>
                </div>
            </Modal>
        </>
